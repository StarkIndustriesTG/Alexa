...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('❣️ 𝙾𝚆𝙽𝙴𝚁', url=f'https://t.me/{SUPPORT_CHAT}')
            ]]
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('🍭 𝙶𝚁𝙾𝚄𝙿 🌟', url='https://t.me/VK_LINKZ')
            ]
            ]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            temp.MELCOW['welcome'] = await message.reply(f"<b>𝙷𝙴𝚈 ♥️ {u.mention}, 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 {message.chat.title}🙂.𝙳𝙾𝙽'𝚃 𝙵𝙾𝚁𝙶𝙴𝚃 𝚃𝙾 𝚂𝙷𝙰𝚁𝙴 & 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝚄𝚂 ✌</b>")
